...
class Tinebase_Setup_Update_Release0 extends Setup_Update_Abstract
{
	...
	// START
	// RCS
	// obtem o gidnumber do grupo no LDAP
	$managerGroup = '902';
	// END
	...
	// START
	// RCS MANAGER ROLE
	// cria a role de gerente no banco de dados
	...
	$managerRole = Tinebase_Acl_Roles::getInstance()->createRole($managerRole);
        Tinebase_Acl_Roles::getInstance()->setRoleMembers($managerRole->getId(), array(
            array(
                'id'    => '902',
                'type'  => Tinebase_Acl_Rights::ACCOUNT_TYPE_GROUP, 
            )
